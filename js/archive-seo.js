...
(function (window) {
  ...
  function buildRecordSEO(record, options = {}){
    ...
    return {title,description:metaDescription,canonical:recordUrl,archiveId:id,name,image:first(record?.hero_image,record?.heroImage,record?.image,record?.cover_image),url:recordUrl,siteUrl:SITE_URL,defaultTitle:DEFAULT_TITLE};
  }
  ...
  function apply(record,options={}){
    ...
    setMeta('meta[property="og:type"]','article'); setMeta('meta[property="og:title"]',seo.title); setMeta('meta[property="og:description"]',seo.description); setMeta('meta[property="og:url"]',seo.url); if(seo.image)setMeta('meta[property="og:image"]',seo.image);
  ...
  window.MiniArchiveSEO=Object.freeze({escapeHtml,buildRecordSEO,apply});
})(window);
